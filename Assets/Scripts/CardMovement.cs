...
public class CardMovement : MonoBehaviour, IDragHandler, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private void TransisitonToState0()
    {
        currentState = 0;
    ...
    public void OnDrag(PointerEventData eventData)
    {
        if (currentState == 2)
        {
                ...
                eventData.position, eventData.pressEventCamera, out Vector2 localPointerPosition))
            {
                ...
                Vector3 offsetOriginal = localPointerPosition - originalLocalPointerPosition;
                rectTransform.localPosition = originalPanelLocalPosition + offsetOriginal;
